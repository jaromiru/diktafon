...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String modelPaused(String label, int pct) {
    return '$label — скачивание приостановлено на $pct %';
  }
  ...
  String pickerDownloading(int pct) {
    return 'скачивается $pct % — нажмите для паузы';
  }

  @override
  String pickerPaused(int pct) {
    return 'пауза на $pct % — нажмите, чтобы продолжить';
  }
  ...
  String retranscribeBody(int count) {
    ...
    return '$_temp0 текущими моделями, и сводка будет составлена заново. Существующие расшифровки и сводки будут заменены, включая ручные правки. Это может занять время.';
  }
  ...
  @override
  String get editTranscript => 'Редактировать расшифровку';

  @override
  String get editTranscriptTitle => 'РЕДАКТИРОВАТЬ РАСШИФРОВКУ';
